% Run of a random MIMO Filter in a loop over varying system size
% runMIMOFilter_loop.m
% Date:             08.05.2019
...
% covariance values
Qcov= 0.1^2;
Rcov= 1e-6^2;   % lower values for larger sytems needed.. why?
...
id=1; % default to only use on d value
% Monte Carlo loop
for iN= 1:N    
...
xlabel('states, outputs')
ylabel('rel. 2-Norm')
title('Relative 2-Norm of est. slopes')

% example_randMIMO_single.m
% Date:             18.08.2019
% Authors:          Daniel Gedon, 4735226
% Description:      Runs a random MIMO system simulation for ONE specific 
%                   system size
...
% A matrix init
tempSelID= 'AIdentity'; %'Arandom'

%% Init system matrices (TT and Matrix)

if strcmp(tempSelID,'Arandom')
    A_tt= genStableTTrank(n,d,rA);
elseif strcmp(tempSelID,'AIdentity')
